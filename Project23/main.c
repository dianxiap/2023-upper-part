...
void UI_SortDatabase(void)
{
	...
	int method,dir;
	printf("请选择排序方式：0-按编号，1-按名称，2-按数量\n");
	scanf("%d",&method);

	printf("请选择排序顺序：0-正序，1-倒序\n");
	scanf("%d",&dir);
	ItemDB_Sort(method,dir);
#endif // 0
    ...
    switch(sort_method)
    {
    case 1: sort_method=SORT_BY_NUMBER;break;
    case 2: sort_method=SORT_BY_NAME;break;
    case 3: sort_method=SORT_BY_QUANTITY;break;
    }
    ...
    switch(sort_dir)
    {
    case 1: sort_dir=SORT_ASCENDING;break;
    case 2: sort_dir=SORT_DESCENDING;break;
    }
